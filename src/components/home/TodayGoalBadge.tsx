          ...
          {rowMembers.map((m, i) => (
            ...
            >
              ...
              {showName && (
                ...
                >
                  <Text style={[styles.nameTagText, { fontSize: nameSize }]}>{m.nickname}</Text>
                </View>
              )}
            </View>
          ))}
      ...
      <Svg width={110} height={106} viewBox="0 0 108 106" style={StyleSheet.absoluteFill}>
        <Defs>
          <LinearGradient id={`${id}_fill1`} x1="0" y1="0" x2="1" y2="1">
            <Stop offset="0%" stopColor="#FF6B3D" stopOpacity={String(0.3 * k)} />
            ...
            <Stop offset="100%" stopColor="#FF6B3D" stopOpacity={String(0.3 * k)} />
          </LinearGradient>
          ...
          <LinearGradient id={`${id}_border`} x1="0" y1="0" x2="1" y2="1">
            <Stop offset="0%" stopColor="#FF6B3D" stopOpacity={String(0.8 * k)} />
            <Stop offset="20%" stopColor="#FFD93D" stopOpacity={String(0.65 * k)} />
            <Stop offset="40%" stopColor="#FF9A5C" stopOpacity={String(0.7 * k)} />
            <Stop offset="60%" stopColor="#FFB380" stopOpacity={String(0.6 * k)} />
            <Stop offset="80%" stopColor="#FFD93D" stopOpacity={String(0.55 * k)} />
            <Stop offset="100%" stopColor="#FF6B3D" stopOpacity={String(0.8 * k)} />
          </LinearGradient>
          <LinearGradient id={`${id}_bloomOuter`} x1="0" y1="0" x2="1" y2="1">
            <Stop offset="0%" stopColor="#FF6B3D" stopOpacity={String(0.2 * k)} />
  ...
  return (
    <View style={styles.finisherBadge}>
      <Svg width={120} height={120} viewBox="0 0 120 120" style={StyleSheet.absoluteFill}>
        ...
        <Path
          d="M 15 75 L 2 75 L 10 85 L 2 95 L 30 95 L 30 75 Z"
          fill={`url(#${id}_ribbonDark)`}
          stroke={`url(#${id}_border)`}
          strokeWidth={isActive ? 2 : 1}
          strokeLinejoin="round"
        />
        <Path
          d="M 105 75 L 118 75 L 110 85 L 118 95 L 90 95 L 90 75 Z"
          fill={`url(#${id}_ribbonDark)`}
          stroke={`url(#${id}_border)`}
          strokeWidth={isActive ? 2 : 1}
          strokeLinejoin="round"
      ...
      <View style={styles.finisherLabelWrap}>
        <Text style={styles.finisherLabelText}>100% 달성</Text>
      </View>
    </View>
  );
}
    ...
    <View style={styles.thumbBadge}>
      ...
      <View style={[styles.medalContentWrap, { top: 12, height: 84 }]}>
        ...
        <Text
          style={[
            styles.holoText,
            { color: isActive ? '#FFF' : 'rgba(255,255,255,0.7)', marginTop: 2, fontSize: 14 },
          ]}
        >
          모두{'\n'}클리어!
        </Text>
